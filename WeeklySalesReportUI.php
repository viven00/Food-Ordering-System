...
include_once("WeeklySalesReportController.php");
$user = new WeeklySalesReportController();
?>
...
<div class="contentBox">
	...
	<div class="table-responsive" style="text-align: left;">
		...
		if (isset($_POST['submit'])) {
			$result = $user->weeklySalesReport($_POST['date']);
			...
			$total = 0;
				...
				<h3> Report for the week: " . $_POST['date'] .
				"</h3>
				<br>
