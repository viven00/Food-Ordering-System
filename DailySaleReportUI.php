...
include_once("DailySalesReportController.php");
$user = new DailySalesReportController();
?>
...
<div class="contentBox">
	...
	<div class="table-responsive" style="text-align: left;">
		...
		if (isset($_POST['submit'])) {
			$result = $user->dailySalesReport($_POST['date']);
			...
			<th align = left>Total&nbsp</th>
				...
				<h3> Report for the date: " . $_POST['date'] .
				"</h3>
				<br>
